...
public:
    ...
    */
    static void drawRotatedQuad(const glm::vec3 &position, const glm::vec2 &size, float rotation, const glm::vec4 &color, Sprite sprite = Sprite(nullptr));
    ...
    * @param sprite leave null for opaque quad
    */
    static void drawQuad(const glm::vec3 &position, const glm::vec2 &size, const glm::vec4 &color, Sprite sprite = Sprite(nullptr));
